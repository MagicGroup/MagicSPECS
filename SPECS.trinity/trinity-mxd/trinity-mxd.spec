...
Summary(zh_CN.UTF-8): Magic xDSL 拨号器
...
Requires:	rp-pppoe, ppp, magic-system-config
...
chmod 755 $RPM_BUILD_ROOT%{tde_bindir}/*
mv $RPM_BUILD_ROOT%{tde_datadir}/applnk/Utilities $RPM_BUILD_ROOT%{tde_datadir}/applnk/Internet
install -m 755 -D %{SOURCE1} $RPM_BUILD_ROOT%{tde_bindir}/mxd-restart
...
%changelog
* Thu Nov 05 2015 Liu Di <liudidi@gmail.com> - 2:0.2-1.3
- 为 Magic 3.0 重建
