...
Patch:          kwine_startmenu-0.1-admin.patch
BuildRoot:      %{_tmppath}/%{name}-%{version}
Prefix:         %(kde-config --prefix)
Requires:       kdelibs >= 3.1, wine, kwinedcop
BuildRequires:  kdelibs-devel >= 3.1, wine-devel, kwinedcop
