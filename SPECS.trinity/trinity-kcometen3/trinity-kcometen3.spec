...
rm -f %{buildroot}%{tde_datadir}/applnk/System/ScreenSavers/%{tde_pkg}.desktop
install -m644 -D %{SOURCE1} %{buildroot}%{tde_datadir}/applnk/System/ScreenSavers/%{tde_pkg}.desktop
install -d %{buildroot}%{tde_datadir}/locale/zh_CN/LC_MESSAGES/
msgfmt %{SOURCE2} -o %{buildroot}%{tde_datadir}/locale/zh_CN/LC_MESSAGES/%{tde_pkg}.mo
