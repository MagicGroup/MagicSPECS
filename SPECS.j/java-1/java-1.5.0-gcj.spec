...
Requires(postun):   %{_bindir}/gcj%{gccsuffix}
# postun requires alternatives to uninstall tool alternatives
Requires(postun): %{_sbindir}/alternatives
...
%changelog
* Fri Nov 30 2012 Liu Di <liudidi@gmail.com> - 1.5.0.0-41
- 为 Magic 3.0 重建

* Thu Jul 19 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.5.0.0-40
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Fri Mar 09 2012 Deepak Bhole <dbhole@redhat.com> - 1.5.0.0-39
- Removed OpenJDK6 specific requirement

* Fri Jan 13 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.5.0.0-38
- Rebuilt for https://fedoraproject.org/wiki/Fedora_17_Mass_Rebuild

* Thu Jun 23 2011 Deepak Bhole <dbhole@redhat.com> 1.5.0.0-37
- Removed triggerin requirements 
- Compensated for triggerin reqs by adjusting Requires/Requires(postun)

* Wed Feb 09 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Wed Oct 13 2010 Alexander Kurtakov <akurtako@redhat.com> 1.5.0.0-35
- Obsolete classpathx-jaf.
