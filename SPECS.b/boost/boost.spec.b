...
%defattr(-, root, root, -)
%doc LICENSE_1_0.txt
%{_libdir}/mpi/lib/libboost_mpi.so.%{sonamever}

%files mpich-devel
%defattr(-, root, root, -)
%doc LICENSE_1_0.txt
%{_libdir}/mpi/lib/libboost_*.so

%files mpich-python
%defattr(-, root, root, -)
%doc LICENSE_1_0.txt
%{_libdir}/mpi/lib/libboost_mpi_python.so.%{sonamever}
%{_libdir}/mpi/lib/mpi.so

%files graph-mpich
%defattr(-, root, root, -)
%doc LICENSE_1_0.txt
%{_libdir}/mpi/lib/libboost_graph_parallel.so.%{sonamever}
