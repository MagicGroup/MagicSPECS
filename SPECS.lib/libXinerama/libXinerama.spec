...
Summary(zh_CN.UTF-8): X.Org X11 libXinerama 运行库
Name: libXinerama
Version: 1.1.3
Release: 3%{?dist}
License: MIT
...
%changelog
* Tue Nov 10 2015 Liu Di <liudidi@gmail.com> - 1.1.3-3
- 为 Magic 3.0 重建

* Sun Nov 01 2015 Liu Di <liudidi@gmail.com> - 1.1.3-2
- 为 Magic 3.0 重建
