...
mv $RPM_BUILD_ROOT%{_includedir}/%{name}-6/magick/magick-config.h \
   $RPM_BUILD_ROOT%{_includedir}/%{name}-6/magick/magick-config-%{wordsize}.h

cat >$RPM_BUILD_ROOT%{_includedir}/%{name}-6/magick/magick-config.h <<EOF
...
%changelog
* Mon Dec 14 2015 Liu Di <liudidi@gmail.com> - 6.9.2.1-4
- 为 Magic 3.0 重建

* Sun Nov 08 2015 Liu Di <liudidi@gmail.com> - 6.9.2.1-3
- 为 Magic 3.0 重建
...
* Fri Oct 19 2012 Liu Di <liudidi@gmail.com> - 6.8.0.1-2
- 为 Magic 3.0 重建
