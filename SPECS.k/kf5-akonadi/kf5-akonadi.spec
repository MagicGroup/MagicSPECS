...
BuildRequires:  kf5-akonadi-server-devel >= 15.11.90
BuildRequires:  kf5-kcontacts-devel >= 15.11.90
BuildRequires:  kf5-kcalendarcore-devel >= 15.11.90
BuildRequires:  kf5-kmime-devel >= 15.11.90
BuildRequires:  kf5-kldap-devel >= 15.11.90
BuildRequires:  kf5-kmbox-devel >= 15.11.90
