...
BuildRequires:  kf5-kconfig-devel >= %{versiondir}
BuildRequires:  kf5-kcoreaddons-devel >= %{versiondir}
BuildRequires:  kf5-kcrash-devel >= %{versiondir}
BuildRequires:  kf5-kdbusaddons-devel >= %{versiondir}
BuildRequires:  kf5-kdoctools-devel >= %{versiondir}
BuildRequires:  kf5-ki18n-devel >= %{versiondir}
BuildRequires:  kf5-rpm-macros >= %{versiondir}
...
Requires:       kf5-kconfig-devel >= %{versiondir}
Requires:       kf5-kcoreaddons-devel >= %{versiondir}
%description    devel
