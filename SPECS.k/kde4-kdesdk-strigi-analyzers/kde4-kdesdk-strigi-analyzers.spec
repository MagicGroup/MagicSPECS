...
%define real_name kdesdk-strigi-analyzers

%define kde4_enable_final_bool OFF

Name: kde4-%{real_name}
Summary: Analyzer plugins for strigi
...
%defattr(-,root,root,-)
%doc COPYING
%{kde4_libdir}/strigi/strigi?a_*.so
%{kde4_datadir}/strigi/fieldproperties/strigi_translation.fieldproperties
