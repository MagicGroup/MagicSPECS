...
URL: http://www.gnu.org/software/%{real_name}/
Source0: ftp://alpha.gnu.org/gnu/%{real_name}/%{real_name}-%{version}.tar.gz
...
* Mon Apr 16 2012 Peter Jones <pjones@redhat.com> - 0.97-90
