...
Version: %{mainver}
Release: %{?prever:0.}2%{?prever}%{?prerelease}%{?dist}.3
...
%changelog
* Fri Nov 13 2015 Liu Di <liudidi@gmail.com> - 3.1.0-0.2.rc2.3
- 为 Magic 3.0 重建

* Wed Nov 04 2015 Liu Di <liudidi@gmail.com> - 3.1.0-0.2.rc2.2
- 为 Magic 3.0 重建
