...
Version:	3.9.6
Release:	2%{?rcver:%{rcver}}%{?numcomm:.%{numcomm}}%{?alphatag:.%{alphatag}}%{?dirty:.%{dirty}}%{?dist}.4
...
%endif
%if 0%{?fedora}
%{_prefix}/lib/systemd/system/ldirectord.service
%{_sbindir}/sfex_*
%{_mandir}/man8/sfex_init.8*
...
%changelog
* Thu Nov 12 2015 Liu Di <liudidi@gmail.com> - 3.9.6-2.4
- 为 Magic 3.0 重建

* Tue Nov 03 2015 Liu Di <liudidi@gmail.com> - 3.9.6-2.3
- 为 Magic 3.0 重建

* Sat Sep 12 2015 Liu Di <liudidi@gmail.com> - 3.9.6-2.2
- 为 Magic 3.0 重建
