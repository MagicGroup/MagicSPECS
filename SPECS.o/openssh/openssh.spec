...
Name: openssh
Version: %{openssh_ver}
Release: %{openssh_rel}%{?dist}%{?rescue_rel}.4
...
Release: %{pam_ssh_agent_rel}.%{openssh_rel}%{?dist}%{?rescue_rel}.5
License: BSD
...
%changelog
* Thu Nov 12 2015 Liu Di <liudidi@gmail.com> - 6.8p1-3.4
- 为 Magic 3.0 重建

* Sun Nov 01 2015 Liu Di <liudidi@gmail.com> - 6.8p1-3.3
- 为 Magic 3.0 重建
