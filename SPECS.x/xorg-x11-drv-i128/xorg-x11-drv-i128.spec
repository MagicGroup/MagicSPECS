...
Summary(zh_CN.UTF-8): Xorg X11 i128 显卡驱动
...
%changelog
* Sun Nov 15 2015 Liu Di <liudidi@gmail.com> - 1.3.6-17
- 为 Magic 3.0 重建

* Fri Nov 06 2015 Liu Di <liudidi@gmail.com> - 1.3.6-16
- 为 Magic 3.0 重建

* Mon Oct 26 2015 Liu Di <liudidi@gmail.com> - 1.3.6-15
- 为 Magic 3.0 重建
...
* Fri Apr 27 2012 Adam Jackson <ajax@redhat.com> 1.3.5-1
- i128 1.3.5

* Thu Apr 05 2012 Adam Jackson <ajax@redhat.com> - 1.3.4-18
- RHEL arch exclude updates

* Sat Feb 11 2012 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-17
- ABI rebuild

* Fri Feb 10 2012 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-16
- ABI rebuild

* Tue Jan 24 2012 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-15
- ABI rebuild

* Wed Jan 04 2012 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-14
- Rebuild for server 1.12

* Fri Dec 16 2011 Adam Jackson <ajax@redhat.com> - 1.3.4-13
- Drop xinf file

* Mon Nov 14 2011 Adam Jackson <ajax@redhat.com> - 1.3.4-12
- ABI rebuild

* Wed Nov 09 2011 Adam Jackson <ajax@redhat.com> 1.3.4-11
- ABI rebuild
- i128-1.3.4-git.patch: Sync with git for new ABI

* Thu Aug 18 2011 Adam Jackson <ajax@redhat.com> - 1.3.4-9
- Rebuild for xserver 1.11 ABI

* Wed May 11 2011 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-8
- Rebuild for server 1.11

* Mon Feb 28 2011 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-7
- Rebuild for server 1.10

* Tue Feb 08 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.3.4-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Thu Dec 02 2010 Peter Hutterer <peter.hutterer@redhat.com> - 1.3.4-5
- Rebuild for server 1.10

* Wed Oct 27 2010 Adam Jackson <ajax@redhat.com> 1.3.4-4
- Add ABI requires magic. (#542742)

* Thu Aug 12 2010 Peter Hutterer <peter.hutterer@redhat.com> 1.3.4-3
- i128 1.3.4
