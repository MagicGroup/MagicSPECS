...
mkdir -p %{buildroot}%{kde4_datadir}/autostart
install -m 644 magic_first_wizard.desktop %{buildroot}%{kde4_datadir}/autostart
...
%{kde4_datadir}/autostart/magic_first_wizard.desktop
%{_datadir}/locale/zh_CN/LC_MESSAGES/magic_first_wizard.mo
%{_datadir}/pixmaps/magic_first_wizard.png

%changelog
* Tue Nov 10 2015 Liu Di <liudidi@gmail.com> - 0.0.2-7
- 为 Magic 3.0 重建
