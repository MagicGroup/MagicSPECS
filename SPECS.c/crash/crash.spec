...
ExclusiveOS: Linux
ExclusiveArch: %{ix86} ia64 x86_64 ppc ppc64 s390 s390x %{arm} mips64el
...
%changelog
* Sat Nov 07 2015 Liu Di <liudidi@gmail.com> - 7.1.3-3
- 为 Magic 3.0 重建

* Wed Oct 28 2015 Liu Di <liudidi@gmail.com> - 7.1.3-2
- 为 Magic 3.0 重建
